      ...
      <ActionTooltip side="right" align="center" label="Home">
        <Link href="/">
          <div className="group flex items-center">
            <div className={cn(
              "flex mx-3 h-[48px] w-[48px] rounded-[24px] group-hover:rounded-[16px] transition-all overflow-hidden items-center justify-center bg-[#5865F2] group-hover:bg-[#4752C4]",
              isActive && "rounded-[16px] bg-[#4752C4]"
            )}>
              <svg
